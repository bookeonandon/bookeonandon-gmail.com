...
<script src="<%=request.getContextPath() %>/resources/js/jquery-3.4.1.min.js" rel="javascript" type="text/javascript"></script>
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/5.css">
<link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/font-awesome/latest/css/font-awesome.min.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/fontawesome-stars.css">
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/jquery.barrating.min.js"></script>
</head>
<body>
    ...
    <div id="book-detail-wrap">
        ...
        <div id="book-detail-content-wrap">
            <div id="thumbnail">
                <img src="<%=request.getContextPath()%>/resources/images/xxlarge.jfif" width="100%">
            </div>
            <div id="book-info">
                ...
                <div id="author"><%=b.getAuthor() %> <p>저</p>
                </div>
                <div id="translator"><%=b.getTranslator()%> <p>역</p>
                </div>
            </div>
            <div id="star-rating">
                <div class="star-rating" style="font-size: 30px; margin-left:40px; font-weight: 900; color:red">
                <%=b.getStarRating() %>
                </div>
                <div class="star-rating" style="margin-top:8px; margin-left:20px; color:red">
                <%=b.getStarRating() %>
                </div>
                <div class="star-rating" style="margin-top:8px;">(<%=b.getReviewCount() %>명)</div>
            </div>
            <div id="buttonArea">
                <%if(loginUser != null){ %>
                <button id="likeBtn" onclick="likeBtn();"><img src="<%=request.getContextPath()%>/resources/images/like1.png" id="like_image" width="90%"></button>
                <button id="cartBtn"><img src="<%=request.getContextPath()%>/resources/images/cart1.png" id="cart_image" width="90%"></button>
                <button id="rentalBtn">대여하기</button>
                <button id="getBtn">소장하기</button>
                <%}else{ %>
                <button id="likeBtn" disabled><img src="<%=request.getContextPath()%>/resources/images/like1.png" id="like_image" width="90%"></button>
                <button id="cartBtn" disabled><img src="<%=request.getContextPath()%>/resources/images/cart1.png" id="cart_image" width="90%"></button>
            ...
            <%if(loginUser != null){ %>
            <form action="<%=contextPath%>/review.rv" method="POST">
                ...
                <div id="review">
                    ...
                    <div id="review-contentArea">
                        <p style="margin-left:630px; margin-bottom:2px"><span id="count">0</span> / 300</p>
                        <textarea id="review-content" name="review-content" cols="70" rows="5"
            ...
            <form>
                <div id="review">
                    <div style="margin-left:30px; font-size: 25px; margin-top:50px;">리뷰</div>
                    <select id="example" style="width:100px;" name="star-score" disabled>
                        <option value="1">1</option>
                        <option value="2">2</option>
                        <option value="3">3</option>
                        <option value="4">4</option>
                    ...
                    <div id="review-contentArea">
                        <p style="margin-left:630px; margin-bottom:2px"><span id="count">0</span> / 300</p>
                        <textarea id="review-content" name="review-content" cols="70" rows="5"
                            placeholder="로그인후 리뷰작성 가능" disabled></textarea>
                    </div>
                    ...
                    <table id="review-list1">
                        <tr>
                            <td width="80px">
	                            ...
	                            <div style="font-size:14px;">2020.02.03</div>
                        ...
                        <tr>
                            ...
                            <td width="600px" style="font-size: 13px; white-space:pre-line; padding-right:40px; padding-left:20px">찾아 방황하였으며, 청춘 장식하는 어디 교향악이다. 이상의 생생하며, 얼마나 있을 산야에 있는 만천하의 거선의 때까지 운다. 옷을 우리 사는가 가치를 간에
        ...
        <!-- 해당카테고리 내 인기도서 -->
        <div id="category-pop">
            <div style="background-color:rgb(112, 48, 160); padding-top:1px; height:60px">
                <h3 style="color:white; padding:0 10px 10px 20px; vertical-align: middle;">카테고리 인기도서</h3>
            </div>
            <div id="list-area">
                <ol>
                    <li><a href="" class="category-pop-list">인기도서</a></li>
                    <li><a href="" class="category-pop-list">인기도서</a></li>
                    <li><a href="" class="category-pop-list">인기도서</a></li>
                    <li><a href="" class="category-pop-list">인기도서</a></li>
                    <li><a href="" class="category-pop-list">인기도서</a></li>
