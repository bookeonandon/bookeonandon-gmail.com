                     ...
                     <div class="card cardsize">
                         ...
                         <div class="card-body termssize">
                             <p> 
				                                 제1장 총 칙 <br>
				                                 제1조 [목 적]<br>
				                                 본 약관은 BOOK E ON&ON 주식회사(이하 “회사”라 합니다)가 운영하는 BOOK E ON&ON을 통하여 제공하는 상품 및 디지털콘텐츠 서비스(이하 “서비스”라 합니다)의 이용과 관련하여 이용자의 권리, 의무 및 책임사항 등을 규정함을 목적으로 합니다.
				                                 <br>
				                                 제2조 [정 의]
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p> 
										                                 제1장 총 칙<br><br>
															제1조 [목 적]<br>
															본 약관은 BOOK E ON&ON 주식회사(이하 “회사”라 합니다)가 운영하는 BOOK E ON&ON를 통하여 제공하는 상품 및 디지털콘텐츠 서비스(이하 “서비스”라 합니다)의 이용과 관련하여 이용자의 권리, 의무 및 책임사항 등을 규정함을 목적으로 합니다.
															<br><br>
															제2조 [정 의]<br>
															본 약관에서 사용하는 용어의 정의는 다음과 같습니다.
															<br><br>
															“BOOK E ON&ON”란 회사가 디지털콘텐츠를 이용자에게 제공하기 위하여 운영하는, 정보통신설비(인터넷, 전화 등)를 이용하여 디지털콘텐츠를 거래할 수 있도록 설정한 가상의 전자상거래 웹사이트를 말합니다.<br>
															...
															"전자책 선물 서비스"라 함은 회사가 운영하는 BOOK E ON&ON 서점 또는 제휴하는 유선인터넷 또는 무선인터넷을 통해 BOOK E ON&ON 전자책을 선물할 수 있는 서비스를 말합니다.<br>
															"수신자"라 함은 전자책 선물 서비스를 회원으로부터 전송 받은 자를 말합니다.<br>
															"사이버머니"라 함은 전자책을 구매할 수 있는 수단이며, 아래와 같이 구분될 수 있습니다.<br>
															북캐시 : 전자책을 구매할 수 있는 결제수단<br>
															북포인트 : 북캐시 충전 및 이벤트 등의 사유로 무상 제공 받을 수 있으며, 전자책을 구매할 때 현금처럼 사용할 수 있는 수단<br>
                                ...
                                <div class="modal fade" id="privacyAgree">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p>
                                                    	BOOK E ON&ON(이하 "회사”라 함)는 고객님들의 개인정보를 소중히 다루고 있습니다. 회사는 ‘정보통신망이용촉진 및 정보 보호 등에 관한 법률’ 등 모든 관련 법규를 준수하며 회원님의 개인정보가 보호받을 수 있도록 최선을 다하고 있습니다. 개인정보 보호정책을 통해 이용자가 제공한 개인정보가 어떠한 용도와 방식으로 이용되며, 개인정보 보호를 위해 어떠한 방법을 통해 관리되고 있는지에 대해 알려드립니다.
														<br><br>
														1. 수집하는 개인정보 항목 및 수집방법<br>
														가. 수집하는 개인정보 항목<br>
														첫째, 회사는 회원가입 및 로그인, 원활한 고객상담, 각종 최적화된 서비스를 제공하기 위하여, 다음과 같은 최소한의 개인정보를 이용자의 회원가입 시 수집하고 있습니다.
														...
														<br><br>
														나. 회원관리<br>
														본인확인, 불량회원(BOOK E ON&ON 이용약관 제16조 위반 사유로 인하여 영구이용이 정지된 회원)의 부정 이용방지와 비인가 사용방지, 가입의사 확인, 분쟁 조정을 위한 기록 보존, 민원처리, 공지사항 전달
														<br><br>
                     ...
                     <div class="card cardsize">
                         ...
                         <div class="card-body">
                             <p>개인 정보 제3자 제공 및 위탁 동의<br>
							   BOOK E ON&ON 주식회사(이하 "회사”라 함)는 고객님들의 개인정보를 소중히 다루고 있습니다. 회사는 ‘정보통신망이용촉진 및 정보 보호 등에 관한 법률’ 등 
                             ...
                             <div class="modal fade" id="privacyProcess">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p>
														BOOK E ON&ON 주식회사(이하 "회사”라 함)는 고객님들의 개인정보를 소중히 다루고 있습니다. 회사는 ‘정보통신망이용촉진 및 정보 보호 등에 관한 법률’ 등 모든 관련 법규를 준수하며 회원님의 개인정보가 보호받을 수 있도록 최선을 다하고 있습니다. 개인정보 보호정책을 통해 이용자가 제공한 개인정보가 어떠한 용도와 방식으로 이용되며, 개인정보 보호를 위해 어떠한 방법을 통해 관리되고 있는지에 대해 알려드립니다.
														<br><br>
														1. 수집하는 개인정보 항목 및 수집방법<br>
														가. 수집하는 개인정보 항목<br>
														첫째, 회사는 회원가입 및 로그인, 원활한 고객상담, 각종 최적화된 서비스를 제공하기 위하여, 다음과 같은 최소한의 개인정보를 이용자의 회원가입 시 수집하고 있습니다.
