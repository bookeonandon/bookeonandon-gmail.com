...
<body>
		...
		<div class="content-body">
            ...
            <div class="container-fluid">
                ...
                <!-- 컨텐츠 헤더 -->
            <form class="content-form" action="<%=contextPath %>/insert.no" method="POST">
                ...
                <table class="content-table">
                    ...
                    <tr>
                        ...
                        <td height="45px"><input type="text" class="form-control input-default" name="noticeTitle"></td>
                    </tr>
                    <tr>
                        <th class="content-th"><span class="content-text">내 용</span></th>
                        <td><textarea class="form-control h-150px" cols="150" rows="20" name="noticeContent" style="resize:none"></textarea></td>
                    </tr>
                </table>
                <hr>
