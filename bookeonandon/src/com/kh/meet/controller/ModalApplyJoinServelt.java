...
/**
 * Servlet implementation class ModalApplyJoinServelt
 */
@WebServlet("/applyJoin.mt")
public class ModalApplyJoinServelt extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ModalApplyJoinServelt() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RoomMemSet rms = new MeetService().RoomMemSetSelect(userNo, roomNo);
