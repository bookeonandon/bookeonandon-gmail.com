...
public class MyCoupon {
   ...
   public MyCoupon(String cName, Date cStart, Date cLast, int cRange) {		// 추가됨!!!!
	super();
	this.cName = cName;
	this.cStart = cStart;
	this.cLast = cLast;
	...
	public int getcRange() { // 추가됨!!!!
		return cRange;
	}
	
	public void setcRange(int cRange) { // 추가됨!!!!
		this.cRange = cRange;
	}
