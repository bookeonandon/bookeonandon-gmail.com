...
/**
 * Servlet implementation class AdminBookInsertServlet
 */
@WebServlet("/insert.abk")
public class AdminBookInsertServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(ServletFileUpload.isMultipartContent(request)) {
			...
			int result = new BookService().adminInsertBook(b);
			...
			if(result > 0) {
				...
				request.setAttribute("msg", "도서 등록실패");
